...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top " style="background-color: #eacefe; ">
        ...
        <div class="collapse navbar-collapse " id="navbarCollapse ">
            <ul class="navbar-nav mr-auto ">
                <li class="nav-item ">
                    <a class="nav-link " style="color: #541191; " href="home_login.html">Home</a>
                </li>
            ...
            <ul class="nav ">
                <li class="nav-item "><a href="index.html" class="nav-link px-2 " style="color: #541191; ">Logout</a>
                </li>
                <li class="nav-item "><a href="userprofile.html" class="nav-link px-2 " style="color: #541191; ">
                        <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="User" class="rounded-circle"
                            width="30"></a></li>
            </ul>
            ...
            <div class="py-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category"
                        onclick="document.location='drinks_page.php'"> Drinks <span
                        ...
                        ?></span></li>
                    <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category"
                        onclick="document.location='dryfood_page.php'"> Dry food <span
                            class="badge badge-primary badge-pill">
                            <?php
                    ...
                    <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category"
                        onclick="document.location='fresh_page.php'"> Fresh food <span
                            class="badge badge-primary badge-pill">
                            <?php
                    ...
                    <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category"
                        onclick="document.location='frozen_page.php'"> Frozen food <span
                            class="badge badge-primary badge-pill">
                            <?php
        ...
        <section id="products" style="margin-top: 40px;">
            <div class="card-group">
                <div class="container py-3">
                    <div class="row">
                        <?php
                                $list=mysqli_query($mysqli,"SELECT * FROM shoppinglist");
                                $query=mysqli_query($mysqli,"SELECT * FROM product WHERE ProductCategory='Dry food'");
                        ...
                        <div class="card col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1 pt-lg-4 pt-4"
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="add2list btn btn-primary" id="add2list"
                                        style="margin-left: 10px;" onclick="openModal(this)">
    ...
    <?php
        if(isset($_GET['submit'])){
            $listID = $_GET['selectedList'];
            $productID = $_GET['ID'];
            $quantity=$_GET['quantity'];
            
            $add = mysqli_query($mysqli,"INSERT INTO listcontent (ListID,ProductID,Quantity) VALUES ('$listID','$productID','$quantity')");
        }
        ?>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-xl-2 col-md-4 col-sm-4 col-12">
                            ...
                            <p style="padding-right: 30px;text-align: justify;text-justify: inter-word;">
                                ...
                                own shopping list in a few clicks!</p>
                        </div>
                        <div class="col-xl-2 col-md-4 col-sm-4 col-12">
