...
<body>
    ...
    <?php
        ...
        if($submit=="Add"){
            echo "<h5 style='text align:centre;color:slateblue'> Product added to shopping list.  
            <strong><a href='shoppinglist.php' class='alert-link'>View shopping list</a></strong></h5>";
        }
        ?>
