...
<nav class="navbar navbar-expand-md navbar-dark fixed-top " style="background-color: #eacefe; ">
    ...
    <span class="navbar-toggler-icon "></span>
        ...
        <div class="collapse navbar-collapse " id="navbarCollapse ">
            ...
            <li class="nav-item ">
                <a class="nav-link " style="color: #541191; " href="home_admin.php">Home</a></li>
...
<ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" href="adminprofile.php">User Profile</a>
    </li>
    
    <li class="nav-item">
      <a class="nav-link" style="color:black" href="adminpassword.php">Password</a>
    </li>
</ul>
</div>
