...
<?php
                    $list = mysqli_query($mysqli, "SELECT * FROM shoppinglist WHERE Status='Deleted' AND userid='$id'");
...
<?php endwhile?>
      ...
      <script>
                $('.listbutton').click(function(){
                    ...
                    $.ajax({url:"historymodal.php?ID="+ID+"&n="+LName,cache:false,success:function(result){
