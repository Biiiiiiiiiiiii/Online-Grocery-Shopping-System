...
<div class="modal-body">
    ...
    $query = mysqli_query($mysqli, "SELECT shoppinglist.ListID AS listID,shoppinglist.ListName AS listName,product.ProductID AS proID, product.ProductName AS productName,product.ProductPrice AS price,product.ProductPhoto AS photo,listcontent.Quantity AS quantity
                                            ...
                                            INNER JOIN product ON listcontent.ProductID = product.ProductID) WHERE shoppinglist.Status='Active' AND shoppinglist.userid='$id' AND shoppinglist.ListID='$lid1'");
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            ...
                            <button class="quantity-left-minus btn btn-outline-secondary" type="button" width="16" height="16" onclick="minus(this)">-</button>

                            <div class="quantity-input">
                                <input type="text" id="quantity" name="quantity" class="form-control" value="<?php echo $row['quantity'] ?>" min="1" max="100" style="max-width:50px">
                            </div>

                            <button class="quantity-right-plus btn btn-outline-secondary" type="button" width="16" height="16" onclick="plus(this)">+</button>
                        </div>

                        <!--...............................................Delete.................................................-->
                        
                        <input type="hidden" class="conProd" name="yes">
                        <input type="hidden" class="conEdit" name="update">
                        ...
                        <br><input type="submit" name="deleteProduct" onclick="popFunction()" class="btn btn-outline-danger" id="ProductID" value="Delete">
                        <input type="submit" name="updateProduct" onclick="updateFunction()" class="btn btn-outline-primary" id="updateProduct" value="Save changes">
    ...
    <br><input type="submit" name="deleteList" class="btn btn-danger btn-block" onclick="yesFunction()" id='listName' value="Delete List">
    </form>
...
<div class="modal-footer">
    ...
    <!--<button type="button" class="btn btn-primary btn-success" onclick="alert('Changes have been saved.')" data-bs-dismiss="modal">Save changes</button>-->
</div>
